...
Case 4 : Class member variables are extracted if given, otherwise ... is standing.
Case 5 : Types of class member variables are extracted.
Case 6 : Visibility of class member variables are extracted.

Case 7 : Class method names are extracted.
Case 8 : Class method parameter names are extracted.
Case 9 : Class method parameters are extracted including the types of parameters, otherwise ... is standing.
Case 10 : Class method return value types are extracted, otherwise ... is standing.
Case 11 : Visibility of methods are extracted.
Case 12 : Classes without constructors are identified as interfaces or abstract classes.
"""
"""
Notes:
